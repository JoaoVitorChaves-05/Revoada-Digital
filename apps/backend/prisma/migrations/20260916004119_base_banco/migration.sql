-- CreateEnum
CREATE TYPE "public"."ProfileType" AS ENUM ('STUDENT', 'TEACHER', 'ADMIN');
...
-- CreateIndex
CREATE UNIQUE INDEX "approval_requests_userId_key" ON "public"."approval_requests"("userId");
...
-- AddForeignKey
ALTER TABLE "public"."approval_requests" ADD CONSTRAINT "approval_requests_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
